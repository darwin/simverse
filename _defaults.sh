...
export BTCD_MINING_ADDR=${BTCD_MINING_ADDR:-mp76nrashrCCYLy3a8cAc5HufEas11yHbh} # note this is a regtest address
export BTCD_MINING_ADDR_PRIVATE_KEY=${BTCD_MINING_ADDR_PRIVATE_KEY:-cP2SDKHK9PwQyBwRcnCTar4R5iv8HMPNZs6aCNRJ5o736cWcYGsZ} # note this is a regtest key
